...
Helper function `torus_create()` is loaded at this stage, this is available from [put link to zenodo version of repo once created] (for now it's [here](github.com/laurajanegraham/UPSCALING/R)).
