...
p1 <- w1_plot + ggtitle("1. Define the analysis scales and calculate the\n    measure of variability, for each predictor\n    grain cell")
...
p2 <- ggplot() + 
  ...
  theme(axis.line = element_blank(), 
        ...
        axis.title = element_blank(), 
        panel.border = element_blank()) + 
  ggtitle("2. Calculate the predictor grain moving window\n    values")
