...
coefflabel <- c("Intercept", "MWDA Shannon\n(50 m)", 
              "MWDA Shannon\n(100 m)", "MWDA Shannon\n(500 m)", "MWDA Shannon\n(1 km)", 
...
MWDA Shannon a stronger correlate of relative abundance than SDA Shannon, smaller the window, the stronger the correlation. Although all Shannon measures correlate with the amount of habitat, MWDA Shannon (0.5km) is least correlated with this (still very high). 
