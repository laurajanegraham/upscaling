...
jay_plot <- ggplot(jay_narrow %>% filter(variable == "index10")) + 
  ...
  scale_fill_viridis_c(name = "Jay abundance", option = "magma")
...
```{r results_out, fig_width = 14, fig.height = 8}
...
save_plot("~/Google Drive/SCALEFORES/Papers/Upscaling/figures/jay_figure.tiff", 
          box_figure, base_width = 12, base_height = 9.375, dpi = 300)
save_plot("~/Google Drive/SCALEFORES/Papers/Upscaling/figures/lores_jay_figure.png", 
          box_figure, base_width = 12, base_height = 9.375)
```
