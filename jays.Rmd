...
varlabel <- c("Abundance (2010 Atlas)", "MWDA Shannon\n(50 m)", 
              "MWDA Shannon\n(100 m)", "MWDA Shannon\n(500 m)", "MWDA Shannon\n(1 km)", 
              "MWDA Shannon\n(1.5 km)", "MWDA Shannon\n(3.5 km)", "SDA Shannon", 
...
coefflabel <- c("Intercept", "MW Shannon\n(50 m)", 
              "MWDA Shannon\n(100 m)", "MWDA Shannon\n(500 m)", "MWDA Shannon\n(1 km)", 
              "MWDA Shannon\n(1.5 km)", "MWDA Shannon\n(3.5 km)", "SDA Shannon", "Forest %", 
              "MWDA Shannon : Temperature", "SDA Shannon : Temperature", 
              "Urban %", "Temperature")
...
cov_plot <- ggplot(jay_narrow %>% filter(variable %in% c("winshannon100", "habitat", "urban", "bio1"))) + 
  geom_sf(aes(fill = value), colour = NA) +
  coord_sf(crs = st_crs(jay_narrow), datum = NA) + 
