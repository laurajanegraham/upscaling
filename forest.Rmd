...
`r figs("pairs", paste("Pairs plot of *Garrulus glandarius* relative abundance and covariates. Correlations shown are Spearman's", expression(rho), "."))`
...
```{r FX_forests_results, fig.width = 4.33071, fig.height = 6.496065}
