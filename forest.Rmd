...
theme_set(theme_classic(base_size = params$plot_font_size) + 
...
eu_pts <- gCentroid(eu_grid, byid=TRUE)

forests_sp <- st_as_sf(eu_grid) %>% bind_cols(raster::extract(var_stack, eu_pts) %>% as.tibble)
